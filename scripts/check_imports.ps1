...
mods = [
 ...
 'data.loaders','data.splits','data.wildjailbreak','data.multiturn_jailbreak','data.sleeper_builder','data.attack_fingerprints','data.real_attack_corpus','data.external_sources','data.external_sleeper',
 ...
 'eval.judge','eval.generate','eval.metrics','eval.ablations','eval.significance','eval.mechanistic_taxonomy','eval.conjunction_tests','eval.causal_interventions','eval.null_controls','eval.transfer','eval.layer_sweep','eval.strong_judge',
